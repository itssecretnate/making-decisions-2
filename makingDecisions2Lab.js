...
// Alternate way that follows a flow
if(score >= 90) console.log("A");
else if(score < 60) console.log("F");
else if(score <= 69) console.log("D");
else if(score <= 79) console.log("C");
else if(score <= 89) console.log("B");
else console.log("Ran into a problem.");
...
for(let i = 0; i < listOfNumbers.length; i++) {
  if(listOfNumbers[i] % 3 === 0) console.log(`${listOfNumbers[i]} is disvisible by 3.`);
}
...
switch(letterGrade) {
  ...
  case "F":
    console.log("The student is failling");
    break;
...
/*
for(let i = 1; i <= 100; i++) {
  if(modCheck(i, 3) && modCheck(i, 5)) console.log("Devmountain");
  else if(modCheck(i, 3)) console.log("Dev");
  else if(modCheck(i, 5)) console.log("mountain");
  else console.log(i);
}

function modCheck(numberToCheck, divisbleByNumber)
{
  if(numberToCheck % divisbleByNumber === 0) return true;
  else return false;
}
*/
